...
public class FramerController {
    ...
    @Operation(summary = "Returns a json document that contains data related to field of view and depth of field. </br>You need to pass in values for the camera location and subject location in WGS84 coordinates (latitude, longitude), </br>the focal length of your lens in millimeter (e.g. 400), </br>the aperture of your lens in f/stop (e.g. 4.5), </br>the sensor format of your camera (e.g. full_format, aps_c) and </br>the orientation of the shot (landscape or portrait).",
               description = "The service will calculate the distance from the camera to the subject, </br>the field of view (width, height) and </br>the depth of field (area before and behind the subject etc.).</br>All distances are either in millimeter (sensor_width, sensor_height, focal_length) or in meter (distance_to_subject, hyper_focal_distance, fov_width, fov_height, dof_near_limit, dof_far_limit, dof_total).</br>All angles are given in degrees (fov_width_angle, fov_height_angle)")
