...
public class Data {
    ...
    @Override public String toString() {
        ...
        final String res = new StringBuilder().append(CURLY_BRACKET_OPEN)
                                              ...
                                              .append(QUOTES).append("fov_width_angle").append(QUOTES).append(COLON).append(fovWidthAngle).append(COMMA)
                                              .append(QUOTES).append("fov_height_angle").append(QUOTES).append(COLON).append(fovHeightAngle).append(COMMA)
